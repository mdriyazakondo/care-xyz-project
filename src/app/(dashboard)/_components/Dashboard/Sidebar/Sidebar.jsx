...
export default function Sidebar({ navLinks }) {
  ...
  return (
    <>
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 h-16 bg-background border-t-2 border-gray-200 dark:border-slate-800 flex items-center justify-around px-2 z-50">
